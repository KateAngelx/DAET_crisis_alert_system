...
export const EMERGENCY_FALLBACK = {
  ...
  message:
    'In a life-threatening emergency, contact local services immediately: PNP 117, BFP 160, DOH 1555, or your barangay/LGU emergency hotline. This application supports tourism safety coordination but requires internet connectivity and power.',
  hotlines: [
