...
export function CommunicationChannelForm({ initialChannels, onSave, saving = false, submitLabel = "Save Preferences" }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <p className="text-sm text-zinc-600 font-medium">
        Choose how Daet LGU can reach you for crisis alerts and important updates. You can change this anytime in your profile.
      </p>
      ...
      <button
        type="submit"
        disabled={saving}
        className="w-full py-4 bg-blue-600 text-white rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center gap-2"
      >
...
export function CommunicationChannelOnboarding() {
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <Card className="w-full max-w-lg p-6 sm:p-8 rounded-3xl shadow-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-blue-600">Welcome</p>
