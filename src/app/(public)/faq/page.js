  ...
  return (
    ...
    <div className="rounded-xl border border-zinc-200 bg-zinc-50/40 overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between gap-4 p-4 sm:p-5 text-left hover:bg-zinc-50 transition-colors"
      ...
      {open ? (
        ...
        <div className="px-4 sm:px-5 pb-4 sm:pb-5 text-sm text-zinc-600 font-medium leading-relaxed border-t border-zinc-100 pt-4">
  ...
  return (
    ...
    <PublicPageShell>
      ...
      <PublicPageContent>
        ...
        <PublicPanel title="Questions & answers" subtitle="Tap a question to expand" bodyClassName={portalLayout.scrollPane}>
        ...
        <PublicPanel title="Emergency contacts" subtitle="For immediate danger, call first">
